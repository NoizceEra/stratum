...
(function () {
  ...
  window.addEventListener('keydown', function (e) {
    ...
    if (e.key === 'Escape') { if (S.mapOpen) toggleMap(); if (S.travelOpen) closeTravel(); if (S.craftOpen) closeCraft(); if (S.lbOpen) closeLeaderboard(); if (S.wardrobeOpen) closeWardrobe(); return; }
